...
if(NOT "include;/home/robotlab/catkin_ws/src/vtec/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vtec_tracker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotlab/catkin_ws/install/${idir}'.  ${_report}")
    endif()
