...
if("TRUE" STREQUAL "TRUE")
  set(drive_SOURCE_PREFIX /home/robotlab/catkin_ws/src/drive)
  set(drive_DEVEL_PREFIX /home/robotlab/catkin_ws/devel)
  set(drive_INSTALL_PREFIX "")
  set(drive_PREFIX ${drive_DEVEL_PREFIX})
else()
  set(drive_SOURCE_PREFIX "")
  set(drive_DEVEL_PREFIX "")
  set(drive_INSTALL_PREFIX /home/robotlab/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotlab/catkin_ws/src/drive/${idir}'.  ${_report}")
    endif()
