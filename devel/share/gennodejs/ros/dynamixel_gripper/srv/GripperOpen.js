...
class GripperOpenRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GripperOpenRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GripperOpenRequest
    let len;
    let data = new GripperOpenRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GripperOpenRequest(null);
...
class GripperOpenResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GripperOpenResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GripperOpenResponse
    let len;
    let data = new GripperOpenResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GripperOpenResponse(null);
...
module.exports = {
  ...
  Response: GripperOpenResponse,
  md5sum() { return 'bb1d916c0cb02d122a8698fce1017916'; },
  datatype() { return 'dynamixel_gripper/GripperOpen'; }
};
